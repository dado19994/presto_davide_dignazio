<div class="checkout-wrapper">
    ...
    <button type="button" class="btn btn-primary custom-btn-card px-5 py-3 rounded-pill fw-bold shadow-lg"
                ...
                <div class="modal-body p-4 text-white">
                    @if ($step == 1)
                        <div class="step-1 animate__animated animate__fadeIn">
                            <div
                                class="d-flex align-items-center mb-4 p-3 rounded-3 bg-white bg-opacity-5 border border-white border-opacity-10">
                            ...
                            <button wire:click="nextStep"
                                class="btn btn-primary w-100 py-3 rounded-pill fw-bold">Continua al pagamento</button>
                        </div>
                    @elseif($step == 2)
                            ...
                            <div class="payment-options d-flex flex-column gap-3 mb-4">
                                <div class="payment-option p-3 rounded-3 bg-white bg-opacity-5 border {{ $paymentMethod == 'card' ? 'border-primary' : 'border-white border-opacity-10' }} cursor-pointer"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <i
                                            class="fas {{ $paymentMethod == 'card' ? 'fa-dot-circle text-primary' : 'fa-circle text-white-50' }}"></i>
                                    </div>
                                </div>
                                <div class="payment-option p-3 rounded-3 bg-white bg-opacity-5 border {{ $paymentMethod == 'paypal' ? 'border-primary' : 'border-white border-opacity-10' }} cursor-pointer"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <i
                                            class="fas {{ $paymentMethod == 'paypal' ? 'fa-dot-circle text-primary' : 'fa-circle text-white-50' }}"></i>
                                    </div>
                                </div>
                            </div>

                            <div
                                class="ai-protection mb-4 p-3 rounded-3 bg-primary bg-opacity-10 border border-primary border-opacity-20 d-flex align-items-start">
                                <i class="fas fa-shield-alt text-primary mt-1 me-3"></i>
                                <p class="m-0 small text-white-50">Transazione protetta da <span
                    ...
                    @else
                        <div class="step-3 text-center py-4 animate__animated animate__zoomIn">
                            ...
                            <p class="text-white-50 mb-4">Il tuo ordine è stato elaborato con successo. Riceverai una
