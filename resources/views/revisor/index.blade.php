<x-layout>
    <x-page-header
        eyebrow="Area revisore"
        title="Dashboard revisione"
                    ...
                    <div class="col-12 col-lg-7">
                        <div class="revisor-gallery">
                            <div class="revisor-gallery-main">
                                <img
                                    src="https://picsum.photos/900/620"
                                    class="img-fluid revisor-main-image"
                                    alt="Immagine principale articolo {{ $article_to_check->title }}"
                                >
                            </div>
                            ...
                            <div class="row g-3 mt-1">
                                @for ($i = 0; $i < 4; $i++)
                                    <div class="col-6 col-md-3">
                                        <img
                                            src="https://picsum.photos/30{{ $i }}/220"
                        ...
                        <div class="article-detail-content revisor-content h-100 d-flex flex-column">
                            <div>
                                @if ($article_to_check->category)
                                    <a href="{{ route('byCategory', ['category' => $article_to_check->category]) }}" class="article-detail-badge text-capitalize text-decoration-none">
